...
Taking the gradient w.r.t $\theta$ to get
$$
\nabla v_\pi(s) = \sum_{a\in\mathcal{A}}\nabla\pi(a|s)q_\pi(a,s) + \pi(a|s)\nabla q_\pi(a,s)
$$

Using the definition of the action value and the return $G_t$ we get 
