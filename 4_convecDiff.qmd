...
Note that from now on, matrices and vector are denoted in bold italic. With $N = A-B$, the approximate solution of @eq-convec_diff_steady is then the solution of the linear system
