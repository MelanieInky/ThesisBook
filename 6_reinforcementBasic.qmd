...
With the Markov property. If we ignore the rewards and consider a fixed policy, then the Markov decision process becomes a Markov chain. 
:::
...
Putting @eq-state_value_part1 and @eq-state_value_part2 together, we get Bellman equation.
...
Similarly $v_\pi(s_1) = 4.1 + \gamma(0.9,0.1)(v_\pi(s_1),v_\pi(s_2))^\intercal$. This lead to the system 
