...
:::{.remark}
A fundamental property of the MDP is Markov property, or lack of memory, that is to say that the action taken at instant t $A_t$ is only dependent on the state $S_t$ and not the state before. Mathematically $p(A_t|S_t, S_{t-1}, \dots , S_0) = p(A_t|S_t)$.
:::
