...
+ theme_bw()
+ xlab('Episode number')
+ coord_cartesian(ylim=(-0.001,0.0075))
+ scale_color_manual(values = ['#1d493bff', '#fc9167ff', '#506fb0ff']))
