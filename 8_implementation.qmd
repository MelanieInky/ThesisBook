...
While the average reward converges. The same cannot be said for the $\theta$ parameters(see @fig-variable_theta). In particular, $\theta_2$ seem to not converge. Running the program for more episode did not resolve this issue.
