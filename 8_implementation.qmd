...
With this change implemented, we rerun the first experiment. All the parameters are the same, except that the learning rate can now be set to $\alpha = 1\times 10^{-4}$ without divergence! The results are in 
...
#| echo: false
#| fig-cap: Evolution of the rolling average (k=50) of the average episode reward.
#| warning: false
