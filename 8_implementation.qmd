...
- The discount rate is set to a low value of $\gamma = 0$, as the state transitions are completely random, there is no reason to prefer long term rewards.
